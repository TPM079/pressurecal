...
export function buildRigSearchParams(inputs: PartialInputs): URLSearchParams {
  ...
  if (inputs.pumpPressure !== undefined && inputs.pumpPressure !== "") params.set("pumpPressure", String(inputs.pumpPressure));
  if (inputs.pumpPressureUnit) params.set("pumpPressureUnit", inputs.pumpPressureUnit);
  if (inputs.pumpFlow !== undefined && inputs.pumpFlow !== "") params.set("pumpFlow", String(inputs.pumpFlow));
  if (inputs.pumpFlowUnit) params.set("pumpFlowUnit", inputs.pumpFlowUnit);
  if (inputs.maxPressure !== undefined && inputs.maxPressure !== "") params.set("maxPressure", String(inputs.maxPressure));
  if (inputs.maxPressureUnit) params.set("maxPressureUnit", inputs.maxPressureUnit);
  if (inputs.hoseLength !== undefined && inputs.hoseLength !== "") params.set("hoseLength", String(inputs.hoseLength));
  if (inputs.hoseLengthUnit) params.set("hoseLengthUnit", inputs.hoseLengthUnit);
  if (inputs.hoseId !== undefined && inputs.hoseId !== "") params.set("hoseId", String(inputs.hoseId));
  if (inputs.hoseIdUnit) params.set("hoseIdUnit", inputs.hoseIdUnit);
  if (inputs.engineHp !== undefined && inputs.engineHp !== "") params.set("engineHp", String(inputs.engineHp));
  if (inputs.sprayMode) params.set("sprayMode", inputs.sprayMode);
  if (inputs.nozzleCount !== undefined && inputs.nozzleCount !== "") params.set("nozzleCount", String(inputs.nozzleCount));
  if (inputs.nozzleSizeText) params.set("nozzleSizeText", inputs.nozzleSizeText);

  return params;
}

export function buildLiteRigSearchParams(inputs: PartialInputs): URLSearchParams {
  const params = new URLSearchParams();
  if (inputs.pumpPressure !== undefined && inputs.pumpPressure !== "") params.set("pumpPressure", String(inputs.pumpPressure));
  if (inputs.pumpPressureUnit) params.set("pumpPressureUnit", inputs.pumpPressureUnit);
  if (inputs.pumpFlow !== undefined && inputs.pumpFlow !== "") params.set("pumpFlow", String(inputs.pumpFlow));
...
export function buildFullRigSearchParams(inputs: PartialInputs): URLSearchParams {
