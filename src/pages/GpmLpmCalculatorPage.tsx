...
export default function GpmLpmCalculatorPage() {
  ...
  return (
    <PressureCalLayout>
      <Helmet>
        <title>GPM to LPM Converter | Pressure Washer Flow Calculator</title>
        <meta
          name="description"
          content="Convert GPM to LPM and LPM to GPM for pressure washer setups, pumps, and machine specs. Check common flow conversions fast, including 4 GPM to LPM and 5.5 GPM to LPM."
        />
        <link
          rel="canonical"
        ...
        <meta
          property="og:title"
          content="GPM to LPM Converter | Pressure Washer Flow Calculator"
        />
        <meta
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            operatingSystem: "Web",
            description:
              "Convert GPM to LPM and LPM to GPM for pressure washer setups, pumps, and machine specs. Check common flow conversions fast, including 4 GPM to LPM and 5.5 GPM to LPM.",
          })}
        </script>
      </Helmet>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm md:p-8">
          <div className="mb-6">
            ...
            <p className="mt-3 text-base text-slate-600">
              Convert GPM to LPM and LPM to GPM for pressure washer setups, pumps,
              nozzle checks, and machine specifications.
            </p>
          </div>
